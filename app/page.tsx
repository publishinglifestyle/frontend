    ...
    <>
      {
        isClient && (
          <head>
            <title>Login or Sign Up to Low Content AI - AI-Powered Book Creation Platform</title>
            <meta
              name="description"
            ...
            <meta property="og:title" content="Login or Sign Up to Low Content AI" />
            <meta
            ...
            <meta name="twitter:title" content="Login or Sign Up to Low Content AI" />
            <meta
            ...
            <script
              ...
              dangerouslySetInnerHTML={{
                __html: JSON.stringify({
                  ...
                  "description": "Access Low Content AI to create low-content books using AI tools.",
