...
export default function GamesLayout({
    ...
    return (
        <>
            ...
            {isClient && (
                <head>
                    <title>Play and Create Games with Low Content AI - Interactive Game Generation</title>
                    <meta
                        name="description"
                    ...
                    <meta property="og:title" content="Play and Create Games with Low Content AI" />
                    <meta
                    ...
                    <meta name="twitter:title" content="Play and Create Games with Low Content AI" />
                    <meta
                    ...
                    <script
                        ...
                        dangerouslySetInnerHTML={{
                            __html: JSON.stringify({
                                ...
                                "description": "Create and play a variety of interactive games using AI.",
