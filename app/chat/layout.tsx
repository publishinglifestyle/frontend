...
export default function ChatLayout({
    ...
    return (
        <>
            ...
            {isClient && (
                <head>
                    <title>Chat with Low Content AI - Interactive AI-Powered Book Creation</title>
                    <meta
                        name="description"
                    ...
                    <meta property="og:title" content="Chat with Low Content AI - Interactive Book Creation" />
                    <meta
                    ...
                    <meta name="twitter:title" content="Chat with Low Content AI - Interactive Book Creation" />
                    <meta
                    ...
                    <script
                        ...
                        dangerouslySetInnerHTML={{
                            __html: JSON.stringify({
                                ...
                                "description": "Engage with Low Content AI to create interactive, low-content books.",
