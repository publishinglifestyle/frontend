...
const CreditsModal: React.FC<CreditsModalProps> = ({ isOpen, onClose, onPurchase }) => {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} size="md" isDismissable={false} isKeyboardDismissDisabled={true}>
            <ModalContent>
                ...
                <ModalBody style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
                    ...
                    >
                        <SelectItem key="1" value="9.99">
                            9.99$ - 8M credits
                        </SelectItem>
                        <SelectItem key="2" value="19.99">
                            19.99$ - 16M credits
                        </SelectItem>
                        <SelectItem key="3" value="39.99">
                            39.99$ - 32M credits
                        </SelectItem>
                    </Select>
                </ModalBody>
