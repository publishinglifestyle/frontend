...
interface IdeogramModalProps {
    isOpen: boolean;
    onClose: () => void;
    onSuccess: (selectedTab: string, styleType: string, aspectRatio: string, negativePrompt: string, remixPrompt: string, uploadedImageUrl: string) => void;
}
...
const IdeogramModal: React.FC<IdeogramModalProps> = ({ isOpen, onClose, onSuccess }) => {
    ...
    const handleImageChange = async (e: ChangeEvent<HTMLInputElement>) => {
        if (e.target.files && e.target.files.length > 0) {
            ...
            // Log temporary URL (to display image locally before upload)
                                ...
                                <Card>
                                    <CardBody>
                                        ...
                                        <Input
                                            ...
                                            onChange={(e: ChangeEvent<HTMLInputElement>) => setNegativePrompt(e.target.value)}
                                            size='sm'
                                            radius='lg'
                                            variant="bordered"
                                        />
                                ...
                                <Card>
                                    <CardBody>
                                        <Input
                                            ...
                                            fullWidth
                                            value={remixPrompt}
                                            onChange={(e: ChangeEvent<HTMLInputElement>) => setRemixPrompt(e.target.value)}
                                            size='sm'
                                            radius='lg'
                                            variant="bordered"
                                        />
